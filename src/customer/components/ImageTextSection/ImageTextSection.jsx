...
const ImageTextSection = ({image, description}) => {
    return (
        <div className="my-16 mx-28">
            <img className="w-48 h-auto mx-auto mb-5" src={divider} alt="Divider" />
            <div className="grid grid-cols-2 gap-6">
                <div>
                    <h4 className="font-heading text-h4 text-neutral-900">Bring the restaurant experience home</h4>
                    <p className="text-p text-neutral-900 font-regular py-10">At Banh Mi & Bites, we’re passionate about sharing the authentic flavors of different parts 
                ...
                <div>
                    ...
                    <p className="text-p text-neutral-900 font-regular pt-10">
